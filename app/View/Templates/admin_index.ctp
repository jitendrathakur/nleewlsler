<div class="templates index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('template_html'); ?></th>
			<th><?php echo $this->Paginator->sort('footer_text'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($template['Template']['template_html']); ?>&nbsp;</td>
		<td><?php echo h($template['Template']['footer_text']); ?>&nbsp;</td>
